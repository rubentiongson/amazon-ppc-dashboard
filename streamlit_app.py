...
section.main > div { max-width: 1440px; padding-top: 0.2rem; }
...
st.markdown(
    "<div class='topbar'><div class='top-title'>PPC Insights</div>"
    "<div class='chip'>🏦 ACCOUNT SELECTION ▾</div></div>",
...
for col, (label, val, delta, trend) in zip(st.columns(4), cards):
    ...
    col.markdown(
        ...
        f"<div class='k-val'>{val}</div><span class='badge {cls}'>{delta}</span>"
        f"</div></div>",
        unsafe_allow_html=True,
    )
...
<div class='table-shell'>
  <div class='table-head'>
    <div class='section-title' style='font-size:20px;margin:0'>Top Performing Campaigns</div>
    <div class='v'>VIEW ALL REPORTS</div>
  </div>
  <table class='tbl'>
    <thead>
      <tr>
